...
{
    public class PlayerActionPreview : MonoBehaviour
    {
        [SerializeField] private SpriteRenderer mainIcon;
        [SerializeField] private SpriteRenderer staminaIcon;
        [SerializeField] private TextMeshPro staminaDescription;
